...
const Skill = () => {
  const skills = [
    ...
    { name: "NODEJS", progress: 50, color: "#8cc84b", description: "Basic knowledge of Node.js and building server-side applications. Currently learning to integrate Node.js with front-end technologies." },
